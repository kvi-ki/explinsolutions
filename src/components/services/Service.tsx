export default function Service({ name }: { name: string }) {
  return (
    <li className="bg-white border border-green rounded-xl p-2 m-4 w-1/3 aspect-square flex flex-col justify-center sm:1/6 md:w-1/6 xl:w-48">
      <h3 className="w-full text-center text-wrap text-sm">{name}</h3>
