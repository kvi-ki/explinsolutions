...
export default function Footer() {
  return (
    <footer className="h-96 pt-12 pl-4 pr-4 pb-12 bg-darkGray grid md:grid-cols-2 gap-x-8 gap-y-8 md:pl-8 md:pr-8">
      <section className="w-52 flex justify-between items-center">
        <img
          src="/favicon.png"
      ...
      <section className="text-sm text-white font-extralight flex flex-col gap-4 justify-center md:items-end">
        <p>
